...
[![Open in Codespaces](https://classroom.github.com/assets/launch-codespace-2972f46106e565e64193e422d61a12cf1da4916b45550586e14ef0a7c637dd04.svg)](https://classroom.github.com/open-in-codespaces?assignment_repo_id=15398653)
# SESION DE LABORATORIO N° 01: GESTION AUTOMATIZADA DE PRUEBAS CON GITHUB
## Erick Churacutipa Blas
## OBJETIVOS
...
env:
  ...
  SONAR_ORG: 'erickchuracutipa'                    # Nombre de la organización de sonar cloud
  SONAR_PROJECT: 'erickchuracutipa_bancaapp'        # Key ID del proyecto de sonar
on:
  push:
    branches: [ "main" ]
  workflow_dispatch:
